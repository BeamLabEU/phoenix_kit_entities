...
# skip as the other `phoenix_kit_*` packages (e.g. `phoenix_kit_ai`,
# `phoenix_kit_dashboards`, `phoenix_kit_crm`) that carry their own Gettext backend.
[
  {"lib/phoenix_kit_entities/gettext.ex", :call_without_opaque}
]
